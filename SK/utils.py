...
def getTicks(array_width, array_height, w, fineness):
    ...
    try:
        ...
        ticks = [
            np.arange(
                0,
                min(array_width, array_height),
                min(array_width, array_height) / num_ticks,
            ),
            np.arange(
                0,
                min(array_width, array_height),
...
def stretch_IB(ib_psf, res):
    ...
    grid_x, grid_y = np.mgrid[
        0 : extent : extent / ib_size_px, 0 : extent : extent / ib_size_px
    ]
